...
REPLACES the earlier, more detailed entry at this page's request: same underlying
matter, written up deliberately without the case number or other case-identifying
detail, and without the specifics of how the litigation concluded. Status corrected
to "disposed" — the case was not superseded by PECA as the previous version of this
entry said; it was fully litigated to a final conclusion on its own terms, well
documented in public court records. Kept off this page at the site owner's request.
