---
title: "Electronic cigarettes for smoking cessation (Cochrane living systematic review)"
authors: "Lindson N, et al."
...
periodically updated — cite the DOI's base identifier (CD010216) and
check for a newer `.pubN` suffix before publishing, since the exact
sub-version located here (pub10) should be reconfirmed against Cochrane's
site rather than assumed permanent. Plain-language summary on
[Cochrane.org](https://www.cochrane.org/evidence/CD010216_can-electronic-cigarettes-help-people-stop-smoking-and-do-they-have-any-unwanted-effects-when-used).
